...
class AdaptadorListaCancha(
    private val listaCanchas: ArrayList<Cancha>,
    private val contexto: ListaCancha,
    private val recyclerView: RecyclerView
) :
    RecyclerView.Adapter<AdaptadorListaCancha.MyViewHolder>() {
